...
# Based on 500 simulation runs, outputs the magnitude of mean shift (shift), the value of ARL (ARL), and the standard error (std) of BYJUMPS under scenario 6S
sig_6S = c(0.0025, 0.01, 0.03, 0.03)
time_horizon_6S = c(2,5,3,5)
h_6S = c(11.232, 10.255, 9.232, 9.197)    
for (shift in 1:4)
{
  sig = sig_6S[shift]
  time_horizon = time_horizon_6S[shift]
  h = h_6S[shift]
  arl = NULL
  for (seed in 1:500)
  {
  ...
  print(paste0("6S:shift = ", shift, " ARL = ", average, " std = ", std))
}